...
Extensive experiments on MIT-BIH ECG, WAY-EEG-GAL, CIFAR-10, BUS-BRA and DEAP demonstrate that E-KAT can automatically learn task-dependent structural preferences and effective connectivity patterns. The proposed model achieves 98.63% accuracy on MIT-BIH-ECG, 96.77% on WAY-EEG-GAL, and 91.82% on CIFAR-10, while maintaining lightweight complexity, requiring only 0.54M parameters and 0.0246G MACs on ECG, 1.60M parameters and 0.1227G MACs on EEG, and 3.51M parameters and 0.10G MACs on CIFAR-10. Multi-cluster coupling further improves multimodal regression performance and convergence on DEAP. Overall, E-KAT reduces repeated manual architectural refinement by providing interpretable guidance on model structure within a predefined macro-architecture.
...
![Framework](picture/E-KAT_structure.png)
